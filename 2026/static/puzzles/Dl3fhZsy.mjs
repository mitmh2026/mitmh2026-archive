...
import { i as useGlobalVolume, R as RotateCcw, T as TwemojiText, j as Play } from "./CPm4UabO.mjs";
import { c as createLucideIcon, B as Button } from "./CyHnzWK1.mjs";
...
function TamitgotchiEmulator() {
  ...
  reactExports.useEffect(() => {
    let mounted = true;
    import("./BCUbA1JG.mjs").then((module) => module.default()).then((result) => {
      if (!mounted) return;
...
//# sourceMappingURL=Dl3fhZsy.mjs.map
