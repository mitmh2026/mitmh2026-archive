...
const CAPSTONE_SLUG = "unexplored_frontiers";
const PuzzleComponent = () => {
  ...
  return CAPSTONE_SLUG in solvedPuzzles ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "You have a chance to work at Novabucks for a day. The Eland Islands Puzzmon are eager to try your coffee!" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(ClickableMonarchDevice, { zoneSlug: "eland_islands", className: "w-20" }),
    ","
  ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(PuzzleInfoBox, { copyable: false, children: [
    "You need to solve the",
    " ",
    /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: `/2026/hunt/puzzles/${CAPSTONE_SLUG}`, children: "Eland Islands capstone puzzle" }),
    " ",
...
//# sourceMappingURL=BOjxwfMS.js.map
