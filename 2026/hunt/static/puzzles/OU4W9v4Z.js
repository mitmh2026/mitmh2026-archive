...
const CAPSTONE_SLUG = "filial_pie_tree";
const PuzzleComponent = () => {
  ...
  return CAPSTONE_SLUG in solvedPuzzles ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
    "The Royal Groves Puzzmon are looking to redecorate. Can you design a place that optimizes their needs and preferences?",
    /* @__PURE__ */ jsxRuntimeExports.jsx(ClickableMonarchDevice, { zoneSlug: "royal_groves", className: "w-20" }),
    ","
  ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(PuzzleInfoBox, { copyable: false, children: [
    "You need to solve the",
    " ",
    /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: `/2026/hunt/puzzles/${CAPSTONE_SLUG}`, children: "Royal Groves capstone puzzle" }),
    " ",
...
//# sourceMappingURL=OU4W9v4Z.js.map
